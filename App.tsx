...
const LINEUP: Artist[] = [
  { 
    ...
    description: 'Arquitetos do abismo audível, tecendo tapeçarias de sintetizadores pesados que exploram as fronteiras entre a consciência digital e orgânica.'
  },
  { 
    id: '2', 
    name: 'Data Mosh', 
    ...
    description: 'Desconstruindo a batida para reconstruí-la em um caos de alta definição. Espere texturas glitch, ritmos quebrados e pura entropia sonora.'
  },
  { 
    id: '3', 
    name: 'Ether Real', 
    ...
    description: 'Techno vindo de uma dimensão de luz pura. Loops hipnóticos e vocais etéreos que flutuam sobre uma base de graves industriais.'
  },
  { 
    id: '4', 
    name: 'Hyper Loop', 
    ...
    description: 'Drum & bass de alta velocidade que acelera os batimentos cardíacos para acompanhar o ritmo do pulso neon da cidade.'
  },
  { 
    id: '5', 
    name: 'Digital Soul', 
    ...
    description: 'House music profunda e ressonante que encontra o fantasma na máquina, misturando samples cheios de alma com design de som futurista.'
  },
  { 
    id: '6', 
    name: 'Void Walker', 
    ...
    description: 'Paisagens sonoras ambientais para o fim do mundo. Uma jornada contemplativa através da matéria escura e do silêncio.'
  },
];
    ...
    <div className="relative min-h-screen text-white selection:bg-[#4fb7b3] selection:text-black cursor-auto md:cursor-none overflow-x-hidden">
      ...
      <header className="relative h-[100svh] min-h-[600px] flex flex-col items-center justify-center overflow-hidden px-4">
        ...
        >
          ...
          >
            Uma odisseia audiovisual imersiva
          </motion.p>
        </motion.div>
              ...
              <div key={key} className="flex whitespace-nowrap shrink-0">
                {[...Array(4)].map((_, i) => (
                  <span key={i} className="text-3xl md:text-7xl font-heading font-black px-8 flex items-center gap-4">
                    ...
                    EUFORIA VISUAL <span className="text-black text-2xl md:text-4xl">●</span> 
                  </span>
                ))}
              </div>
            ))}
        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16 px-4">
             <h2 className="text-5xl md:text-8xl font-heading font-bold uppercase leading-[0.9] drop-shadow-lg break-words w-full md:w-auto">
              Ondas <br/> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#a8fbd3] to-[#4fb7b3]">Sonoras</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
            <div className="lg:col-span-5 order-2 lg:order-1">
              <h2 className="text-4xl md:text-7xl font-heading font-bold mb-6 md:mb-8 leading-tight">
                Além da <br/> <GradientText text="REALIDADE" className="text-5xl md:text-8xl" />
              </h2>
              <p className="text-lg md:text-xl text-gray-200 mb-8 md:mb-12 font-light leading-relaxed drop-shadow-md">
                Lumina não é apenas um festival; é uma expedição sensorial. Fundimos tecnologia de áudio de ponta com arte generativa para criar um ecossistema vivo e pulsante de som.
              </p>
              
              <div className="space-y-6 md:space-y-8">
                {[
                  { icon: Globe, title: 'Distrito Estelar', desc: 'Caminhe entre construtos de luz de 15 metros de altura.' },
                  { icon: Zap, title: 'Áudio Neuro-Link', desc: 'Pisos hápticos que sincronizam com seus batimentos cardíacos.' },
                  { icon: Music, title: 'Palco Infinito', desc: 'Visuais gerados por IA que reagem à energia da multidão.' },
                ].map((feature, i) => (
                  <div
                    key={i} 
      ...
      <section id="tickets" className="relative z-10 py-20 md:py-32 px-4 md:px-6 bg-black/30 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
             <h2 className="text-5xl md:text-9xl font-heading font-bold opacity-20 text-white uppercase">
               ACESSO
             </h2>
             <p className="text-[#a8fbd3] font-mono uppercase tracking-widest -mt-3 md:-mt-8 relative z-10 text-sm md:text-base">
               Sincronize sua frequência
             </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: 'Passe Diário', price: '$149', color: 'white', accent: 'bg-white/5' },
              { name: 'Passaporte', price: '$349', color: 'teal', accent: 'bg-[#4fb7b3]/10 border-[#4fb7b3]/50' },
              { name: 'VIP Astral', price: '$899', color: 'periwinkle', accent: 'bg-[#637ab9]/10 border-[#637ab9]/50' },
            ].map((ticket, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl md:text-3xl font-heading font-bold mb-4 text-white uppercase">{ticket.name}</h3>
                    ...
                    <ul className="space-y-4 md:space-y-6 text-sm text-gray-200">
                      <li className="flex items-center gap-3"><Ticket className="w-5 h-5 text-gray-400" /> Entrada Geral</li>
                      <li className="flex items-center gap-3"><MapPin className="w-5 h-5 text-gray-400" /> Todos os Palcos</li>
                      {i > 0 && <li className="flex items-center gap-3 text-white"><Zap className={`w-5 h-5 text-[#a8fbd3]`} /> Entrada Exclusiva</li>}
                  ...
                  >
                    <span className="relative z-10">
                      {isPurchasing ? 'Processando...' : isPurchased ? 'Garantido' : 'Comprar'}
                    </span>
                  ...
                  {isPurchased && (
                    ...
                    >
                      Site demo: nenhuma cobrança real
                    </motion.p>
                  )}
                </motion.div>
              );
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div>
             ...
             <div className="flex gap-2 text-xs font-mono text-gray-400">
               <span>criado por @chanelluuh</span>
             </div>
          </div>
